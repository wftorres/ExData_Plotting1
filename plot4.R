...

{
      ...
      ## currently, the script requires the files to be located in the base folder.
      path2files <- ""
      ...
      plot(dfile$Time, dfile$Global_ac, main = "", sub = "", xlab = "", ylab = "", type = "l")
      title(ylab = "Global Active Power")
      
      plot(dfile$Time, dfile$Voltage, main = "", sub = "", xlab = "", ylab = "", type = "l")
      title(xlab = "datetime", ylab = "voltage")            
      
      plot(dfile$Time, dfile$Sub_metering_1, main = "", sub = "", xlab = "", ylab = "", type = "l")
      lines(dfile$Time, dfile$Sub_metering_2, col="red")
      lines(dfile$Time, dfile$Sub_metering_3, col="blue")
      legend("topright", legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), lty=c(1,1,1), col=c("black","red","blue"))
      title(ylab = "Energy sub metering")
      
      plot(dfile$Time, dfile$Global_re, main = "", sub = "", xlab = "", ylab = "", type = "l")
